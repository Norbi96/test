      ...
      <div>
        <nav class="flex h-9 items-center justify-between" aria-label="Global">
          ...
          <div class="hidden lg:flex lg:min-w-0 lg:flex-1 lg:justify-center lg:gap-x-12">
            <a href="/social" class="font-semibold text-gray-900 hover:text-gray-900">Közösség</a>  
            <a href="/market" class="font-semibold text-gray-900 hover:text-gray-900">Marketplace</a>
            <a href="/social" class="font-semibold text-gray-900 hover:text-gray-900">Rólunk</a>
          </div>
    ...
    <main>
      <div class="relative px-6 lg:px-8">
        <div class="mx-auto max-w-3xl pt-20 pb-32 sm:pt-48 sm:pb-40">
          <div>
            <div>
              <h1 class="text-4xl font-bold tracking-tight sm:text-center sm:text-6xl">MÁRTON VIKTOR</h1>
              <p class="mt-6 text-lg leading-8 text-gray-600 sm:text-center">Ügyviteli és Vállalatirányítási rendszerek, <br>Professzionális weboldalfejlesztés a marketing eszközöket alkalmazva</p>
